...
public class Main2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //방법4
        BackThread3 thread4 = new BackThread3(handler4); //메인스레드의 Handler 객체를 외부 클래스에 넘겨줌.
        ...
        public void run(){
            while(true){
                ...
                handler2.post(new Runnable() {
                    @Override
                    public void run() { //Runnable의 run()엣 메인 UI 접근
...
// Message 를 수신합니다.
Handler handler1 = new Handler(){  //익명클래스
        @Override
